...
function maperror() {
    alert("Could not open the map at this time try refreshing and checking the url");
}
...
var ViewModel = function() {
    ...
    this.menustate = ko.observable(false);
    this.menuwidth = ko.observable(false);
    ...
    self.queryData = ko.pureComputed({
        read: self.query,
